...
function Delivering() {
    ...
    const getClass = (data) => {
        if(data){
            console.log(data)
            return "bg-[red] translate-y-2 rounded w-[13%] md:w-[17%] rounded-full h-[2vh]";
           
    
        }else{
            return "bg-[white] border-[red] border-[1px] translate-y-2 rounded w-[13%] md:w-[17%] rounded-full h-[2vh]"
        }
      }
  return (
